...
#define CFG_CFGCON0_GPSOSCE_Pos               _UINT32_(5)                                          /* (CFG_CFGCON0) GPIO/SOSC Enable Position */
#define CFG_CFGCON0_GPSOSCE_Msk               (_UINT32_(0x1) << CFG_CFGCON0_GPSOSCE_Pos)           /* (CFG_CFGCON0) GPIO/SOSC Enable Mask */
#define CFG_CFGCON0_GPSOSCE(value)            (CFG_CFGCON0_GPSOSCE_Msk & (_UINT32_(value) << CFG_CFGCON0_GPSOSCE_Pos)) /* Assigment of value for GPSOSCE in the CFG_CFGCON0 register */
...
#define CFG_CFGCON0_Msk                       _UINT32_(0x7777FFFF)                                 /* (CFG_CFGCON0) Register Mask  */
...
#define CFG_CFGCON0_SLRTEN_Msk                (_UINT32_(0x3) << CFG_CFGCON0_SLRTEN_Pos)            /* (CFG_CFGCON0 Mask) SLRTEN */
...
#define CFG_CFGCON1_RESETVALUE                _UINT32_(0x1700443B)                                 /*  (CFG_CFGCON1)   Reset Value */
...
#define CFG_CFGCON1_Msk                       _UINT32_(0x7F76DFBB)                                 /* (CFG_CFGCON1) Register Mask  */

#define CFG_CFGCON1_SLRCTRL_Pos               _UINT32_(11)                                         /* (CFG_CFGCON1 Position) I2C Slew Rate Control for SERCOMx */
#define CFG_CFGCON1_SLRCTRL_Msk               (_UINT32_(0x3) << CFG_CFGCON1_SLRCTRL_Pos)           /* (CFG_CFGCON1 Mask) SLRCTRL */
...
#define CFG_CFGCON1_I2CDSEL_Msk               (_UINT32_(0x3) << CFG_CFGCON1_I2CDSEL_Pos)           /* (CFG_CFGCON1 Mask) I2CDSEL */
...
#define CFG_CFGPCLKGEN1_Msk                   _UINT32_(0xFFF0FFFF)                                 /* (CFG_CFGPCLKGEN1) Register Mask  */
...
#define CFG_PMD3_Msk                          _UINT32_(0x00007FF3)                                 /* (CFG_PMD3) Register Mask  */
