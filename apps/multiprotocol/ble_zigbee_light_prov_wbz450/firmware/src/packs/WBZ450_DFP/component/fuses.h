...
/* file generated from device description file (ATDF) version 2023-11-29T17:03:17Z */
...
#define FUSES_DEVCFG1_Msk                     _UINT32_(0x7F76DFB8)                                 /* (FUSES_DEVCFG1) Register Mask  */

#define FUSES_DEVCFG1_SLRCTRL_Pos             _UINT32_(11)                                         /* (FUSES_DEVCFG1 Position) I2C Slew Rate Control for SERCOMx */
#define FUSES_DEVCFG1_SLRCTRL_Msk             (_UINT32_(0x3) << FUSES_DEVCFG1_SLRCTRL_Pos)         /* (FUSES_DEVCFG1 Mask) SLRCTRL */
...
#define FUSES_DEVCFG1_I2CDSEL_Msk             (_UINT32_(0x3) << FUSES_DEVCFG1_I2CDSEL_Pos)         /* (FUSES_DEVCFG1 Mask) I2CDSEL */
...
#define FUSES_DEVCFG0_GPSOSCE_Pos             _UINT32_(5)                                          /* (FUSES_DEVCFG0) GPIO/SOSC Enable Position */
#define FUSES_DEVCFG0_GPSOSCE_Msk             (_UINT32_(0x1) << FUSES_DEVCFG0_GPSOSCE_Pos)         /* (FUSES_DEVCFG0) GPIO/SOSC Enable Mask */
#define FUSES_DEVCFG0_GPSOSCE(value)          (FUSES_DEVCFG0_GPSOSCE_Msk & (_UINT32_(value) << FUSES_DEVCFG0_GPSOSCE_Pos)) /* Assigment of value for GPSOSCE in the FUSES_DEVCFG0 register */
#define   FUSES_DEVCFG0_GPSOSCE_GPIO_Val      _UINT32_(0x0)                                        /* (FUSES_DEVCFG0)   */
#define   FUSES_DEVCFG0_GPSOSCE_SOSC_Val      _UINT32_(0x1)                                        /* (FUSES_DEVCFG0)   */
#define FUSES_DEVCFG0_GPSOSCE_GPIO            (FUSES_DEVCFG0_GPSOSCE_GPIO_Val << FUSES_DEVCFG0_GPSOSCE_Pos) /* (FUSES_DEVCFG0)  Position  */
#define FUSES_DEVCFG0_GPSOSCE_SOSC            (FUSES_DEVCFG0_GPSOSCE_SOSC_Val << FUSES_DEVCFG0_GPSOSCE_Pos) /* (FUSES_DEVCFG0)  Position  */
...
#define FUSES_DEVCFG0_Msk                     _UINT32_(0x777703F7)                                 /* (FUSES_DEVCFG0) Register Mask  */
...
#define FUSES_DEVCFG0_SLRTEN_Msk              (_UINT32_(0x3) << FUSES_DEVCFG0_SLRTEN_Pos)          /* (FUSES_DEVCFG0 Mask) SLRTEN */
